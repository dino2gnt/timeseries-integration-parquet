...
import org.opennms.timeseries.impl.parquet.util.rrd.DoubleAdapter;
...
public class RRA extends AbstractRRA {
    ...
    /* (non-Javadoc)
     * @see org.opennms.timeseries.impl.parquet.util.rrd.AbstractRRA#createSingleRRA(int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.opennms.timeseries.impl.parquet.util.rrd.AbstractRRA#formatMergeable(org.opennms.timeseries.impl.parquet.util.rrd.AbstractRRA)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.opennms.timeseries.impl.parquet.util.rrd.AbstractRRA#hasAverageAsCF()
     */
    @Override
